...
var _0x5ce7 = ['innerHTML', '3CTGUBP', '1545201onfkOe', '1305573XMhYnp', '1lZpEMF', '968849NKTdrh', '429841xdRSIx', '-->\x20Made\x20by\x20Ayush\x20Master\x20&Sohamsinh.', '1cFTyyw', '261682plyleX', '706235PUAARO', '1KueBkK', '593740bsnvcv'];
...
submit.addEventListener('click', (e) => {
    ...
    if (text.value != "") {
        ...
        second.classList.add("time");
        let input2 = document.createElement('input');
        input2.setAttribute('id','inputArea');
        ...
        var intervalHandle;
        text.value = "";
        mainbox.append(box, check_img, delete_img, timer, second, input2);
